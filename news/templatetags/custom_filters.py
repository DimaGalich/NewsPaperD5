...
censor_words = ['Жидовского', 'Самоходный Дед', 'Плывучий Гроб', 'Грёбаная', 'Попрошайке']
...
def censor(censor_text): # первый аргумент здесь — это то значение, к которому надо применить фильтр, 
    ...
    for word in censor_words:
        censor_text = censor_text.lower().replace(word.lower(), '*censor*')  # переводим в строчные буквы, заменяем на *censor*
